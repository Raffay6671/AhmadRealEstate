      ...
      <div className='chooseContainer'>
        ...
        <div className="chooseReasonContainer">
                <div className="chooseReason">
                        <img className='chooseReasonIcon' src={experience} alt=' not loaded'/>
                ...
                <div className="chooseReason">
                        <img className='chooseReasonIcon' src={profession} alt=' not loaded'/>
                ...
                <div className="chooseReason">
                        <img className='chooseReasonIcon' src={customer} alt=' not loaded'/>
